...
describe Httpd::ZeroDowntime do
  ...
  describe '#staged_rollout' do
    ...
    it 'backs up the configuration file if paths are provided' do
      ...
      subject.staged_rollout(config_path: '/etc/apache2/apache2.conf',
                             backup_path: '/etc/apache2/backup/apache2.conf.bak') do
    ...
    it 'returns false and rolls back if configuration validation fails' do
      ...
      result = subject.staged_rollout(config_path: '/etc/apache2/apache2.conf',
                                      backup_path: '/etc/apache2/backup/apache2.conf.bak')
